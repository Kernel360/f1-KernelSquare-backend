    ...
    public class SearchController {
        ...
        @GetMapping("/search")
        public ResponseEntity<List<FindQuestionResponse>> searchQuestions(@RequestParam String query) {
            List<FindQuestionResponse> searchResults = searchService.searchQuestions(query);

...
public enum CoffeeChatErrorCode implements ErrorCode {
    ...
    COFFEE_CHAT_ROOM_NOT_ACTIVE(HttpStatus.BAD_REQUEST, CoffeeChatServiceStatus.COFFEE_CHAT_ROOM_NOT_ACTIVE, "비활성화 상태의 채팅방"),
    ...
    MESSAGE_DELIVERY_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, CoffeeChatServiceStatus.MESSAGE_DELIVERY_FAILED, "토픽으로 메시지 전달 실패"),

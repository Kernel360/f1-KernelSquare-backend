...
class AuthRequestDtoTest {
    ...
    void validateCheckDuplicateEmailRequest() {
        ...
        Set<ConstraintViolation<CheckDuplicateEmailRequest>> violations1 = validator.validate(checkDuplicateEmailRequest1);
        Set<String> msgList1 = violations1.stream().map(ConstraintViolation::getMessage).collect(Collectors.toSet());

        Set<ConstraintViolation<CheckDuplicateEmailRequest>> violations2 = validator.validate(checkDuplicateEmailRequest2);
    ...
    void validateCheckDuplicateNicknameRequest() {
        ...
        Set<ConstraintViolation<CheckDuplicateNicknameRequest>> violations = validator.validate(checkDuplicateNicknameRequest);

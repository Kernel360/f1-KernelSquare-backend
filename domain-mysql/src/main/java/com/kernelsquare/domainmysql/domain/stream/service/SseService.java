...
import com.kernelsquare.domainmysql.domain.stream.repository.SseRepository;
...
public class SseService {
    ...
    public void notify(Long memberId, Object event, String eventName) {
        sendToClient(memberId, event, eventName);
    }
